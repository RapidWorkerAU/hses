    ...
    <div className="page-stack">
      ...
      <main className="privacy-main">
        <section className="privacy-content">
          ...
          <p className="muted">Last updated: 22 April 2024</p>

          <p>
            At www.hses.com.au, we are committed to protecting your privacy as a
          ...
          <p>
            <strong>Personally Identifiable Information:</strong> We use the
            information we collect to deliver our services to you, including:
            communicating with you, providing technical support, notifying you
            of updates and offers, sharing useful content, measuring customer
          ...
          <p>
            <strong>Non-Personally Identifiable Information:</strong> We also
            use the information we collect in aggregated and anonymized forms to
            improve our services, including: administering our website,
            producing reports and analytics, advertising our products and
            services, identifying user demands and assisting in meeting customer
            needs generally.
          </p>
          <p>
          ...
          <p>
            ...
            information is encrypted before transmission and is not stored by us
            on our servers.
          </p>
          <p>
          ...
          <p>
            ...
            information about your web browsing behaviour. Use of cookies allows
            a website to tailor its configuration to your needs and preferences.
            Cookies do not access information stored on your computer or any
            Personal Data (e.g. name, address, email address or telephone
            number). Most web browsers automatically accept cookies but you can
            choose to reject cookies by changing your browser settings. This
            may, however, prevent you from taking full advantage of our website.
          </p>
          <p>
            ...
            website visitor experience. In addition, cookies and pixels may be
            used to serve relevant ads to website visitors through third party
            services such as Google Ads and Facebook Adverts. These ads may
          ...
          <p>
            We may from time to time need to disclose certain information, which
            may include your Personal Data, to comply with a legal requirement,
            ...
            agency request. Also, we may use your Personal Data to protect the
            rights, property or safety of www.hses.com.au, our customers or
            third parties.
          </p>
          <p>
            ...
            purchaser under a confidentiality agreement. We would only disclose
            your Personal Data in good faith and where required by any of the
            above circumstances.
          </p>
          ...
          <p>
            ...
            ask@hses.com.au and we will respond within 48 hours.
          </p>
        </section>
      </main>
